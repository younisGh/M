...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`relative h-[calc(100vh-4rem)] ${isRtl ? "border-r" : "border-l"} bg-card/80 backdrop-blur supports-[backdrop-filter]:bg-card/60 ${collapsed ? "w-20" : "w-64"} transition-[width] duration-200`}
    >
      <div className="sticky top-16 flex h-[calc(100vh-4rem)] flex-col">
        ...
        <div className="mt-auto p-3 text-xs text-foreground/50">
