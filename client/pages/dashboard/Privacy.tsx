    ...
    <section className="grid gap-4">
      ...
      <div className="space-y-4 rounded-2xl border bg-card p-4 leading-7 text-sm text-foreground/80">
        ...
        <ul className="list-disc pr-6">
          <li>معلومات الحساب الأساسية مثل الاسم ورقم الهاتف والبريد الإلكتروني.</li>
          <li>محتوى المنشورات والتعليقات والرسائل داخل المنصّة.</li>
          <li>بيانات الاستخدام مثل الصفحات التي تزورها وإجراءاتك داخل التطبيق.</li>
        </ul>
        <h2 className="text-lg font-bold">كيفية استخدام المعلومات</h2>
        <ul className="list-disc pr-6">
          <li>تقديم الخدمات وتحسين الأداء وتجربة المستخدم.</li>
          <li>حماية الحسابات ومنع إساءة الاستخدام والامتثال للمتطلبات القانونية.</li>
          <li>إرسال إشعارات متعلقة بالخدمة وتحديثات المزايا.</li>
        </ul>
        <h2 className="text-lg font-bold">مشاركة البيانات</h2>
        <p>
          لا نشارك بياناتك مع أطراف ثالثة إلا عند الضرورة لتقديم الخدمة أو بموافقتك
          أو للالتزام بالقانون. نحرص على تطبيق إجراءات أمان مناسبة لحماية بياناتك.
        </p>
