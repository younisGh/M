    ...
    <article className="group relative overflow-hidden rounded-2xl border bg-card shadow-sm transition hover:shadow-brand">
      ...
      <div className="p-4">
        ...
        >
          <span
            className={
              open ? "whitespace-pre-wrap" : "line-clamp-2 whitespace-pre-wrap"
            }
          >
            {p.body}
          </span>
  ...
  return (
    <article className="group relative overflow-hidden rounded-2xl border bg-card shadow-sm transition hover:shadow-brand">
      <div className="relative aspect-[16/9] overflow-hidden">
        {playing ? (
          ...
          <>
            ...
            <button
              ...
              title="تشغيل"
            >
              <span className="grid h-12 w-12 place-items-center rounded-full bg-black/50 backdrop-blur text-xl">
                ▶
              </span>
            </button>
          </>
        ...
        <div className="absolute left-2 top-2 rounded-full bg-black/40 px-2 py-1 text-xs text-white">
          فيديو
        </div>
      </div>
      <div className="p-4">
    ...
    () => [
      {
        ...
        description:
          "ملخص عن خطوط الإنتاج والطاقة الاستيعابية والميزات التقنية.",
        thumbnailUrl:
          "https://images.unsplash.com/photo-1581092598539-6603cf16e2aa?q=80&w=1600&auto=format&fit=crop",
      ...
      },
      {
        ...
        description:
          "عرض بصري لمخططات البنى التحتية للمستودعات وساحة الحاويات.",
        thumbnailUrl:
          "https://images.unsplash.com/photo-1517502474097-f9b30659dadb?q=80&w=1600&auto=format&fit=crop",
        videoUrl:
  ...
  return (
    <section className="relative">
      ...
      <div className="pointer-events-none fixed inset-x-0 bottom-4 z-50 flex justify-center gap-3">
        <Link
          to="/subscribers"
          className="pointer-events-auto inline-flex h-12 w-12 items-center justify-center rounded-xl bg-sky-600 text-white shadow-lg shadow-black/10 transition hover:brightness-110"
          title="الرئيسية"
          aria-label="الرئيسية"
        >
        ...
        <button
          ...
          className="pointer-events-auto inline-flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-600 text-white shadow-lg shadow-black/10 transition hover:brightness-110"
          title="إضافة منشور"
        ...
        <button
          ...
          className="pointer-events-auto inline-flex h-12 w-12 items-center justify-center rounded-xl bg-amber-500 text-black shadow-lg shadow-black/10 transition hover:brightness-110"
          title="إضافة فيديو"
        ...
        <button
          ...
          className="pointer-events-auto inline-flex h-12 w-12 items-center justify-center rounded-xl bg-indigo-600 text-white shadow-lg shadow-black/10 transition hover:brightness-110"
          title="الدردشة"
          aria-label="الدردشة"
        >
            ...
            <div className="mb-2 grid gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <label
                  ...
                  className="cursor-pointer rounded-xl border px-3 py-2 text-xs hover:bg-accent"
                >
                  إرفاق صورة
                </label>
                {pickedImageUrl && (
              ...
              <textarea
                ...
                className="min-h-[120px] w-full rounded-xl border px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-primary/40"
              />
            </div>
          ...
          <div className="w-[min(92vw,560px)] rounded-2xl border bg-card p-4 shadow-xl">
            ...
            <div className="grid gap-2">
              ...
              <textarea
                ...
                placeholder="تفاصيل الفيديو"
                className="min-h-[90px] w-full rounded-xl border px-4 py-2 text-sm outline-none focus:ring-2 focus:ring-primary/40"
              />
              <input
                value={videoUrl}
